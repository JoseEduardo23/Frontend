            ...
            <form onSubmit={handleSubmit} className="form-passr">
                <div>
                    ...
                    <input
                        ...
                        disabled={loading}
                    />
                    <span className="toggle-pass-passAd" onClick={togglePasswordVisibility}>
                        <div className="diver">
                ...
                <div>
                    ...
                    <input
                        ...
                        disabled={loading}
                    />
                    <span className="toggle-pass-passAd" onClick={togglePasswordVisibility2}>
                        <div className="diver">
