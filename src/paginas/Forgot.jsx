        ...
        <>
            ...
            <div className="forgot-container">
                <div className="forgot-form-container">
                    ...
                    <small className="forgot-subheading">No te preocupes, ingresa el correo electrónico con el que te registraste</small>

                    <form onSubmit={handleSubmit}>
                        <div className="mb-1">
                            <label className="mb-2 block text-sm font-semibold" style={{color:"white"}}>Correo electrónico</label>
                            <input name="email" onChange={handleChange} type="email" placeholder="ej. example@example.com" className="forgot-input" />
                        </div>
